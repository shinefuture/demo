...
autocmd BufNewFile *.cc,*.sh,*.java,*.cpp,*.h,*.hpp,*.py exec ":call SetTitle()"
...
func SetTitle()
    ...
    if filetype_name == ".sh"
        ...
        call append(line(".")+4, "\# Author: shinetimes")
        ...
        call append(line(".")+8, "")
         ...
         if filetype_name == ".py"
                ...
                call append(line(".")+3, " * Author: shinetimes")
                call append(line(".")+4, " * ")
                call append(line(".")+5, " * Last Modified: ".time_value)
                call append(line(".")+6, " * Description: ")
                call append(line(".")+7, " */")
                ...
                if filetype_name == ".h"
                    ...
                    call append(line(".")+11, "")
                    call append(line(".")+12, "#ifdefined (__cplusplus) || defined(c_plusplus)")
                    call append(line(".")+13, "extern \"C\"{")
                    call append(line(".")+14, "#endif")
                    call append(line(".")+15, "")
                    call append(line(".")+16, "")
                    call append(line(".")+17, "#ifdefined (__cplusplus) || defined(c_plusplus)")
                    call append(line(".")+18, "}")
                    call append(line(".")+19, "#endif //__cplusplus")
